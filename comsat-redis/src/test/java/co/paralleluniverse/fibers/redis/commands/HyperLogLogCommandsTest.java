...
public class HyperLogLogCommandsTest extends JedisCommandTestBase {
    ...
    @Test
    public void pfadd() throws ExecutionException, InterruptedException {
    ...
    @Test
    public void pfaddBinary() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
    ...
    @Test
    public void pfcount() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
    ...
    @Test
    public void pfcounts() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
    ...
    @Test
    public void pfcountBinary() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
    ...
    @Test
    public void pfmerge() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
    ...
    @Test
    public void pfmergeBinary() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
