...
public class SortedSetCommandsTest extends JedisCommandTestBase {
    ...
    @Test
    public void zrange() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1d, "a");
    ...
    @Test
    public void zrangeByLex() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1, "aa");
            jedis.zadd("foo", 1, "c");
            jedis.zadd("foo", 1, "bb");
    ...
    @Test
    public void zrangeByLexBinary() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            // binary
    ...
    @Test
    public void zrevrangeByLex() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1, "aa");
            jedis.zadd("foo", 1, "c");
            jedis.zadd("foo", 1, "bb");
    ...
    @Test
    public void zrevrange() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1d, "a");
            jedis.zadd("foo", 10d, "b");
            jedis.zadd("foo", 0.1d, "c");
    ...
    @Test
    public void zincrby() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1d, "a");
            jedis.zadd("foo", 2d, "b");
    ...
    @Test
    public void zrank() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1d, "a");
            jedis.zadd("foo", 2d, "b");
    ...
    @Test
    public void zrevrank() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1d, "a");
            jedis.zadd("foo", 2d, "b");
    ...
    @Test
    public void zrangeWithScores() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1d, "a");
            jedis.zadd("foo", 10d, "b");
            jedis.zadd("foo", 0.1d, "c");
            ...
            Set<Tuple> bexpected = new LinkedHashSet<>();
    ...
    @Test
    public void zrevrangeWithScores() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1d, "a");
            jedis.zadd("foo", 10d, "b");
            jedis.zadd("foo", 0.1d, "c");
    ...
    @Test
    public void zcard() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1d, "a");
            jedis.zadd("foo", 10d, "b");
            jedis.zadd("foo", 0.1d, "c");
    ...
    @Test
    public void zscore() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1d, "a");
            jedis.zadd("foo", 10d, "b");
            jedis.zadd("foo", 0.1d, "c");
    ...
    @Test
    public void zcount() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1d, "a");
            jedis.zadd("foo", 10d, "b");
            jedis.zadd("foo", 0.1d, "c");
    ...
    @Test
    public void zlexcount() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1, "a");
            jedis.zadd("foo", 1, "b");
            jedis.zadd("foo", 1, "c");
    ...
    @Test
    public void zlexcountBinary() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            // Binary
            jedis.zadd(bfoo, 1, ba);
            jedis.zadd(bfoo, 1, bc);
    ...
    @Test
    public void zrangebyscore() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1d, "a");
            jedis.zadd("foo", 10d, "b");
            jedis.zadd("foo", 0.1d, "c");
    ...
    @Test
    public void zrangebyscoreWithScores() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1d, "a");
            jedis.zadd("foo", 10d, "b");
            jedis.zadd("foo", 0.1d, "c");
    ...
    @Test
    public void zremrangeByRank() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1d, "a");
            jedis.zadd("foo", 10d, "b");
            jedis.zadd("foo", 0.1d, "c");
    ...
    @Test
    public void zremrangeByScore() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1d, "a");
            jedis.zadd("foo", 10d, "b");
            jedis.zadd("foo", 0.1d, "c");
    ...
    @Test
    public void zremrangeByLex() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1, "a");
            jedis.zadd("foo", 1, "b");
            jedis.zadd("foo", 1, "c");
    ...
    @Test
    public void zremrangeByLexBinary() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd(bfoo, 1, ba);
            jedis.zadd(bfoo, 1, bc);
            jedis.zadd(bfoo, 1, bb);
    ...
    @Test
    public void zinterstore() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1, "a");
            jedis.zadd("foo", 2, "b");
            jedis.zadd("bar", 2, "a");
    ...
    @Test
    public void tupleCompare() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
    ...
    @Test
    public void zscan() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.zadd("foo", 1, "a");
            jedis.zadd("foo", 2, "b");
