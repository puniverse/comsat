...
public class ListCommandsTest extends JedisCommandTestBase {
    ...
    @Test
    public void llen() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
    ...
    @Test
    public void llenNotOnList() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            try {
                jedis.set("foo", "bar");
                jedis.llen("foo");
    ...
    @Test
    public void lrange() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.rpush("foo", "a");
            jedis.rpush("foo", "b");
            jedis.rpush("foo", "c");
    ...
    @Test
    public void ltrim() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.lpush("foo", "1");
            jedis.lpush("foo", "2");
            jedis.lpush("foo", "3");
    ...
    @Test
    public void lindex() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.lpush("foo", "1");
            jedis.lpush("foo", "2");
            jedis.lpush("foo", "3");
    ...
    @Test
    public void lset() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.lpush("foo", "1");
            jedis.lpush("foo", "2");
            jedis.lpush("foo", "3");
    ...
    @Test
    public void lrem() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
    ...
    @Test
    public void lpop() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.rpush("foo", "a");
            jedis.rpush("foo", "b");
            jedis.rpush("foo", "c");
    ...
    @Test
    public void rpop() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.rpush("foo", "a");
            jedis.rpush("foo", "b");
            jedis.rpush("foo", "c");
    ...
    @Test
    public void rpoplpush() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.rpush("foo", "a");
            jedis.rpush("foo", "b");
            jedis.rpush("foo", "c");
    ...
    @Test
    public void blpop() throws InterruptedException, ExecutionException {
        FiberUtil.runInFiber(() -> {
    ...
    @Test
    public void brpop() throws InterruptedException, ExecutionException {
        FiberUtil.runInFiber(() -> {
    ...
    @Test
    public void linsert() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
    ...
    @Test
    public void brpoplpush() throws ExecutionException, InterruptedException {
        (new Fiber(() -> {
            try {
                Strand.sleep(100);
                Jedis j = createJedis();
