...
public class BitCommandsTest extends JedisCommandTestBase {
    @Test
    public void setAndgetbit() throws ExecutionException, InterruptedException {
    ...
    @Test
    public void bitposWithNoMatchingBitExist() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            String foo = "foo";
    ...
    @Test
    public void setAndgetrange() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
    ...
    @Test
    public void bitCount() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.del("foo");
    ...
    @Test
    public void bitOp() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.set("key1", "\u0060");
            jedis.set("key2", "\u0044");
    ...
    @Test
    public void bitOpNot() throws ExecutionException, InterruptedException {
        FiberUtil.runInFiber(() -> {
            jedis.del("key");
