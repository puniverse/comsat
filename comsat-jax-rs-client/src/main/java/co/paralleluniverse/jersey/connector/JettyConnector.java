...
public class JettyConnector implements Connector {
    ...
    public JettyConnector(Configuration config) {
        ...
        this.client.setMaxConnectionsPerDestination(99999);
    ...
    private static URI getProxyUri(final Object proxy) {
        if (proxy instanceof URI) {
            ...
            throw new ProcessingException("WRONG_PROXY_URI_TYPE: "+JettyClientProperties.PROXY_URI);
        }
    }
    ...
    private Request translateRequest(final ClientRequest clientRequest) {
        ...
        if (method == null) {
            throw new ProcessingException("Method not supported: "+clientRequest.getMethod());
        }
