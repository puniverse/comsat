(defproject co.paralleluniverse/comsat-clj-ring-middleware "0.3.0-SNAPSHOT"
  :description "Comsat integration for the Ring Clojure web framework: fiber-blocking middleware."
